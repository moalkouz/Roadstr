            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Services List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from services where P_ID='$P_ID' order by ID DESC");
                    ...
                    <tr class="grade">
                        ...
                        <td><img src="<?php echo $Picture_1; ?>" width="50%"/></td>
                        <td><img src="<?php echo $Picture_2; ?>" width="50%"/></td>
                        <td><img src="<?php echo $Picture_3; ?>" width="50%"/></td>
                        <td><?php echo $Price; ?> JOD</td>
...
{location.replace('Delete_Service.php?S_ID=<?php echo $S_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a><br>  <a href="Edit_Service.php?S_ID=<?php echo $S_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a></center></td>
 </tr>
