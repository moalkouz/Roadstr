...
$sql1 = mysqli_query($dbConn,"update services set Picture_1='$Picture_1' where ID='$S_ID'");
...
$sql1 = mysqli_query($dbConn,"update services set Picture_2='$Picture_2' where ID='$S_ID'");
...
$sql1 = mysqli_query($dbConn,"update services set Picture_3='$Picture_3' where ID='$S_ID'");
...
$sql1 = mysqli_query($dbConn,"update services set Name='$Name', Description='$Description', Price='$Price', Status='$Status' where ID='$S_ID'");
...
<body style="back">
 ...
 <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Service.php?S_ID=<?php echo $S_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
	...
	<div class="form-group"><label class="col-sm-2 control-label">Description *</label>
                                    ...
                                    <div class="col-sm-10"><textarea style="width:450px" name="Description" class="form-control" required /><?php echo $Description; ?></textarea></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Price (JOD) *</label>
                                    ...
                                    <div class="col-sm-10"><input value="<?php echo $Price; ?>" style="width:450px" type="number" name="Price" min="0" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Picture</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:450px" type="file" name="file2" class="form-control" ></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Picture</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:450px" type="file" name="file3" class="form-control" ></div>
                                </div>
                                <div class="hr-line-dashed"></div>
