...
{location.replace('Delete_Order.php?ID=<?php echo $ID; ?>')}" class="btn btn-danger btn-sm" role="button">Delete</a>
...
<a href="JavaScript:if(confirm('Are You Sure To Accept This Order ?')==true)
{location.replace('Accept_Order.php?ID=<?php echo $ID; ?>')}" class="btn btn-primary btn-sm" role="button">Accept</a>


<br>


<a href="JavaScript:if(confirm('Are You Sure To Reject This Order ?')==true)
{location.replace('Reject_Order.php?ID=<?php echo $ID; ?>')}" class="btn btn-primary btn-sm" role="button">Reject</a>
