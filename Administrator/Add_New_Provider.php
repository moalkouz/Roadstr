...
$insert = mysqli_query($dbConn,"insert into providers (Name,Phone_Number,Address,Logo_Picture,Username,Password,Status) values ('$Name','$Phone_Number','$Address','$Logo_Picture','$Username','$Password','$Status')");
...
echo "<script language='JavaScript'>
			  alert ('New Provider Has Been Added Successfully !');
      </script>";
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Add_New_Provider.php" class="form-horizontal" enctype="multipart/form-data">
								...
								<div class="form-group"><label class="col-sm-2 control-label">Address *</label>
                                    ...
                                    <div class="col-sm-10"><input value="" style="width:450px" type="text" name="Address" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
