...
<body style="back">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>View Customers List Information</h5>
 ...
 <td><center>
  ...
  <a href="View_Customer_Orders.php?C_ID=<?php echo $C_ID; ?>" class="btn btn-primary btn-sm" role="button">View Customer Orders</a>



<br>

 <a href="Edit_Customer.php?C_ID=<?php echo $C_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a>
 <br>
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Customer ?')==true)
{location.replace('Delete_Customer.php?C_ID=<?php echo $C_ID; ?>')}" class="btn btn-primary btn-sm" role="button">Delete</a>
