...
$sql1 = mysqli_query($dbConn,"select * from customers where ID='$C_ID'");
...
$sql1 = mysqli_query($dbConn,"update customers set Password='$Password', Full_Name='$Full_Name', Phone_Number='$Phone_Number', Email_Address='$Email_Address', Status='$Status' where ID='$C_ID'");
							...
							<input type="hidden" name="C_ID" value="<?php echo $C_ID; ?>"/>
                                ...
                                <div class="hr-line-dashed"></div>
								 ...
								 <div class="form-group"><label class="col-sm-2 control-label">Address *</label>
                                    ...
                                    <div class="col-sm-10"><input value="<?php echo $Address ?>" style="width:450px" type="text" name="Address" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
								...
								<div class="form-group"><label class="col-sm-2 control-label">Password *</label>
                                    ...
                                    <div class="col-sm-10"><input value="<?php echo $Password ?>" style="width:450px" type="text" name="Password" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
