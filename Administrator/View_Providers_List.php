...
<body style="back">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
					...
					while ($row1 = mysqli_fetch_array($sql1)){
						...
						$Logo_Picture  = $row1['Logo_Picture'];
                    ...
                    <tr class="grade">
                        ...
                        <td><img src="<?php echo $Logo_Picture; ?>" width="50%"/></td>
 ...
 <td><center>
  ...
  <a href="View_Provider_Orders.php?P_ID=<?php echo $P_ID; ?>" class="btn btn-primary btn-sm" role="button">View Provider Orders</a>
