                    ...
                    <div class="mobile-header__body">
                        ...
                        <div class="mobile-header__indicators">
                            ...
                            <div class="mobile-indicator">
                                <a href="service-details-ar.php?S_ID=<?php echo $S_ID; ?>" class="mobile-indicator__button">
                                            ...
                                            <div class="product__info-body">
                                                ...
                                                <div class="product__prices-stock">
                                                    <div class="product__prices">
                                                        <div class="product__price product__price--current"><?php echo $Price; ?> JOD</div>
                                                    </div>
                                                ...
                                                <div class="product__meta">
                                                    <table>
                                                        <tr>
                                                            <th>Provider</th>
                                                            <td><?php echo $P_Name; ?> <a href='geo:".$P_Latitude.",".$P_Longitude."?q=".$P_Latitude.",".$P_Longitude."(".$P_Name.")' class='btn btn-primary btn-sm' style='color:#fff'>OPEN GOOGLE MAP</a></td>
											...
											<div class="product__actions" >
                                                <div class="product__actions-item " style="width:100%">
                                                    <div class="input-text">
                                                        <textarea class="input-text form-control form-control-lg"  name="Notes" placeholder="Your Notes..."  ></textarea>
                                                    </div>
													
													<br>
													<div class="input-text">
													Service Need In Date
												...
												<br>
                                                    <button type="submit" name="Submit" class="btn btn-primary btn-lg btn-block">Request Service</button>
                                                </div>
                                ...
                                <div class="container">
                                    <div class="section-header">
                                        <div class="section-header__body">
                                            <h2 class="section-header__title">&nbsp;&nbsp;&nbsp;&nbsp;Related Services</h2>
...
$sql1 = mysqli_query($dbConn,"select * from services where (C_ID='$Cat_ID') AND Price>=$Price_From AND Price<=$Price_To AND Status='Active' AND ID!='$S_ID' ");
                                                    ...
                                                    <div class="product-card product-card--layout--grid">
                                                        ...
                                                        <div class="product-card__image">
                                                            <div class="image image--type--product">
                                                                <a href="service-details.php?S_ID=<?php echo $S_ID; ?>" class="image__body">
                                                                    <img class="image__tag" src="../../Providers/<?php echo $Picture_1; ?>" alt="">
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="product-card__info">
                                                            <div class="product-card__name">
                                                                <div>
                                                                    <a href="service-details.php?S_ID=<?php echo $S_ID; ?>"><?php echo $Name; ?> - <?php echo $C_Name; ?></a>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="product-card__footer">
                                                            <div class="product-card__prices">
                                                                <div class="product-card__price product-card__price--current"><?php echo $Price; ?> JOD</div>
                                                            </div>
  ...
  <a href="javascript:history.back()"><i class="fa fa-chevron-circle-left" style="font-size:20px !important" aria-hidden="true"><br><font style="font-size:15px">Back</font></i></a>
  </ul>
  </center>
