...
<body>
    ...
    width: 10px;">
                                <a href="services.php?C_ID=<?php echo $C_ID; ?>" class="mobile-indicator__button">
                                                    ...
                                                    <div class="product-card__info">
														...
														<div class="product-card__name">
                                                            <div>
                                                                ...
                                                                <a href="service-details-ar.php?S_ID=<?php echo $S_ID; ?>"><?php echo $Name; ?></a>
                                                            </div>
                                                        </div>
														
														<div class="product-card__features">
                                                            <ul>
                                                                <li>التفاصيل: <?php echo $Description; ?></li>
