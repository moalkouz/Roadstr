					   ...
					   <h4 class="mobile-header__logo" style="color:#fff; margin-top:7px; margin-left:100px">Roadstr</h4>
                        ...
                        <div class="mobile-header__indicators">
                            ...
                            <div class="mobile-indicator">
                                <a href="services-ar.php?C_ID=<?php echo $C_ID; ?>" class="mobile-indicator__button">
...
<div class="search">
  ...
  <input placeholder="Search..." type="text" name="Search" class="form-control form-control-sm">
  				<input type="submit" name="Submit" >
                                    ...
                                    <div class="products-view__options view-options view-options--offcanvas--always" style="margin-top:-58px">
										...
										<div class="view-options__select">
                                                <label for="view-option-sort">Price:</label>
...
<?php
				...
				$sql1 = mysqli_query($dbConn,"select * from services where Status='Active' AND C_ID='$C_ID' order by ID DESC");
                                                ...
                                                <div class="product-card test3 test6" data-price="<?php echo $Price; ?>" >
                                                    ...
                                                    <div class="product-card__info">
														...
														<div class="product-card__name">
                                                            <div>
                                                                ...
                                                                <a href="service-details.php?S_ID=<?php echo $S_ID; ?>"><?php echo $Name; ?></a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="product-card__footer">
													 ...
													 <div class="product-card__prices">
                                                                <div class="product-card__price product-card__price--new" ><?php echo $Price; ?> JOD</div>
                                                            </div>
