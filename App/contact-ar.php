...
echo "<script language='JavaScript'>
	...
	echo "<script language='JavaScript'>
document.location='index-ar.php';
        </script>";
...
<body>
    ...
    width: 10px;">
                                <a href="contact.php" class="mobile-indicator__button">
        ...
        <div class="site__body">
            ...
            <div style="height:auto !important">
				...
				<form method="post" action="contact-ar.php" style='direction: ltr' >

	 

                    <div><input dir="rtl" type="text" name="Full_Name" value="<?php echo isset($_POST['Full_Name']) ? $_POST['Full_Name'] : '' ?>" placeholder="الاسم الكامل" required></div>

					
  
                    <div><input dir="rtl" type="email" name="Email_Address" value="<?php echo isset($_POST['Email_Address']) ? $_POST['Email_Address'] : '' ?>" placeholder="البريد الإلكتروني" required></div>
                    <div><input dir="rtl" type="text" name="Subject" value="<?php echo isset($_POST['Subject']) ? $_POST['Subject'] : '' ?>" placeholder="العنوان" required></div>
    ...
    border: 1px solid #c5c5c5;
    border-radius: 5px;
    padding: 10px;" name="Message" value="<?php echo isset($_POST['Message']) ? $_POST['Message'] : '' ?>" placeholder="رسالتك" required></textarea>



					
					</div>
                    <div><input type="submit" name="Submit" class="myButton" style="height:46px;" value="ارسل"></div>
