...
$Error = 'Thank You For Signup ! You Can Singin Now !';
...
.signin form a, .signup form a, .change-password form a {
                    ...
                    <div class="mobile-header__body">
                        ...
                        <div class="mobile-header__indicators">
                            ...
                            <div class="mobile-indicator">
                                <a href="signup-ar.php" class="mobile-indicator__button">
  ...
  <INPUT TYPE="hidden" NAME="Longitude" ID="long" VALUE="">
                    ...
                    <div><input type="text" value="<?php echo isset($_POST['Full_Name']) ? $_POST['Full_Name'] : '' ?>" name="Full_Name" placeholder="Full Name" required></div>
                    ...
                    <div><input type="email" name="Email_Address" value="<?php echo isset($_POST['Email_Address']) ? $_POST['Email_Address'] : '' ?>" placeholder="Email Address" required></div>
                    ...
                    <div><input type="submit" name="Submit" value="SIGN UP" class="myButton" style="border:1px solid #334F5D; height:46px;"></div>
