...
<body>
    ...
    <div class="site">
                    ...
                    <div class="mobile-header__body">
                        ...
                        <div class="mobile-header__indicators">
                            ...
                            <div class="mobile-indicator">
                                <a href="about-ar.php" class="mobile-indicator__button">
                ...
                <div class="about__body">
                    ...
                    <div class="about__card">
						...
						<div class="about__card-text">
                            <p style="text-align:justify;">Text Text Text Text Text Text Text Text Text Text Text.
							</p>
                        </div>
		...
		<br>
                <a href="privacy.php" style="border-top: 1px solid #fff;
    ...
    margin-bottom: 30px; background-color: #334F5D;">
                    <div class="row" >
                        <div class="col-10" style="margin-top:5px; color:#fff">&nbsp;&nbsp;PRIVACY POLICY</div>
                        <div class="col-2" style="color:#fff"><i class="fa fa-angle-right fa-2x"></i></div>
                    </div>
                </a>
                <a href="terms.php" style="border-top: 1px solid #fff;
    border-bottom: 1px solid #fff;
    ...
    margin-bottom: 30px; background-color: #334F5D;">
                    <div class="row">
                        <div class="col-10" style="margin-top:5px; color:#fff">&nbsp;&nbsp;TERM OF USE</div>
                        <div class="col-2" style="color:#fff"><i class="fa fa-angle-right fa-2x"></i></div>
                    </div>
                </a>
